...
export STANDALONE_ENABLE="${STANDALONE_ENABLE:-true}"
export RE_CONFIG_ENABLE="${RE_CONFIG_ENABLE:-false}"
export ZOO_4LW_COMMANDS_WHITELIST="${ZOO_4LW_COMMANDS_WHITELIST:-srvr, mntr}"
export DEBUG_MODEL="${DEBUG_MODEL:-false}"
# Zookeeper Server
#export ENABLE_SERVER="${ENABLE_SERVER:-true}"
#export SERVER_ADDRESS="${SERVER_ADDRESS:-0.0.0.0}"
#export SERVER_PORT="${SERVER_PORT:-9876}"
